...
export default function HomemakerDashboard() {
  ...
  const partnerName = localStorage.getItem('partnerName') || localStorage.getItem('partnerUser') || 'Partner';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
                ...
                <div className="hidden md:flex space-x-8 items-center">
                    ...
                    <div
                      className="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 font-bold border border-orange-200"
                      title={partnerName}
                    >
                      {partnerInitial}
                    </div>
